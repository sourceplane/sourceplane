...
var initBlueprintCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		fmt.Println("✅ Created blueprint.yaml")
		fmt.Println("\nNext steps:")
...
var planCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		fmt.Println("⚠️  Run 'sp apply' to create these repositories")
...
var applyCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		for _, repo := range blueprint.Repos {
			...
			fmt.Printf("   ├─ Created intent.yaml\n")
		...
		fmt.Printf("✅ Successfully created %d repository(ies)\n", len(blueprint.Repos))
		fmt.Println("\nNext steps:")
		fmt.Println("  • Initialize Git repositories in each directory")
		fmt.Println("  • Review and commit the generated files")
		fmt.Println("  • Use providers to bootstrap component implementations")
